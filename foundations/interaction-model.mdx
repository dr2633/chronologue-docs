...
Chronologue enables users to collaborate with agents through a chat-based interface, with actions that directly manipulate a shared timeline. Agents interpret natural language prompts to schedule, reflect, reprioritize, and summarize—grounded in structured memory traces and calendar data.
