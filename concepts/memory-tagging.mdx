---
title: "Memory Tagging and Context Control"
group: "Concepts"
---

# Memory Tagging and Context Control
...
Memory tagging in Chronologue is more than an organizational tool. It is a **semantic scaffold for agency**—a way to program memory, personalize behavior, and collaborate through context.

Use tags not only to remember the past, but to guide what comes next.
