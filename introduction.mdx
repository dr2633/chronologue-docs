...
<Accordion title="Prototype: CursorCalendar">
Chronologue includes a working prototype, **CursorCalendar**, which integrates a chat interface directly into a calendar API.
